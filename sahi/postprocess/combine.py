...
def batched_greedy_nmm(
    ...
    """
    #print('\n\nobject_predictions_as_tensor:',object_predictions_as_tensor)
    #print('\n\nlen of object_predictions_as_tensor:',object_predictions_as_tensor.size())
    category_ids = object_predictions_as_tensor[:, 5].squeeze()
    #print('\n\ncategory_ids',category_ids)
    #print('\n\nlen of category_ids',category_ids.size())
    #print('torch.unique(category_ids): ',torch.unique(category_ids))
    keep_to_merge_list = {}
    for category_id in torch.unique(category_ids):
        curr_indices = torch.where(category_ids == category_id)[0]
